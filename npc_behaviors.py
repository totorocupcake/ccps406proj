...
def graze(world_state,charac):
    ...
    if current_y+1 >= 0 and current_y+1 <= max_cols and world_state.get_tiles()[current_x][current_y+1].name == "grasslands":
        available_directions.append("n")
    if current_y-1 >= 0 and current_y-1 <= max_cols and world_state.get_tiles()[current_x][current_y-1].name == "grasslands":
        available_directions.append("s")
    if current_x+1 >= 0 and current_x+1 <= max_rows and world_state.get_tiles()[current_x+1][current_y].name == "grasslands":
