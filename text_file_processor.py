...
def load_tile_JSON_data_file():
    # returns a JSON array of tile data from the JSON tiles_01 file
...
def load_tileIDMapping_file():
    # returns a JSON array of tile-id-mappings data from the JSON tileIDMapping file
...
def load_char_template_file():
    # returns a JSON array of template characters data from the JSON character_template file
